package com.ruchi.frontendProject.service;
...
{      
	 ...
	 private ProductDAO productDAO;
	  ...
	  // return all the product in list form
	  ...
	  public String manageCartLine(int cartLineId, int count) {
			...
			if (product.getQuantity() < count)   // check if that much quantity is available or not
			{
