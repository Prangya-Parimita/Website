        ...
        <c:if test="${not empty message}">
         ...
         <div class="offset-md-1 col-md-10">
			<div class="card">
				...
				<div class="card-heading bg-info text-black text-center">  <!-- heading -->
				...
				<div class="card-body">                                    <!-- body -->
					...
					<div class="form-group row">
					   <label class="col-md-4 col-form-label" for="name"> Enter Brand Name </label>
						  <div class="col-md-6">
					...
					<div class="form-group row">
					   <label class="col-md-4 col-form-label" for="name"> Enter Unit Price </label>
						  <div class="col-md-6">
					...
					<div class="form-group row">
					   <label class="col-md-4 col-form-label" for="name"> Available Quantity </label>
						  <div class="col-md-6">
					...
					<div class="form-group row">
					   <label class="col-md-4 col-form-label" for="description">Enter Product Description </label>
							<div class="col-md-6">
                    ...
                    <div class="form-group row">
							...
							<div class="text-right">
										<button type="button" 
												...
												class="btn btn-primary btn-sm">ADD CATEGORY
										</button>
									</div>
								</c:if>
							</div>
